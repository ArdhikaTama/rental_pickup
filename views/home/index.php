    ...
    <div class="container position-relative" style="z-index: 2;">
        <div class="row align-items-center g-4">
            ...
            <div class="col-lg-6 text-center position-relative">
                <img src="<?= base_url('/assets/images/l300_box-removebg-preview.png') ?>" alt="Premium Pickup Fleet" class="img-fluid position-relative floating-img" style="max-height: 340px; object-fit: contain; z-index: 3;">
            </div>
        </div>
    </div>
</section>
...
<section id="unit" class="py-5" style="background-color: #e6e6e6;">
    <div class="container py-2">
        ...
        <div class="row g-4">
            <?php 
            $categories = [
                ['name' => 'L300', 'harian' => '350.000', 'mingguan' => '1.800.000', 'bulanan' => '5.300.000', 'file' => '/assets/images/l300-removebg-preview.png'],
                ['name' => 'Carry', 'harian' => '300.000', 'mingguan' => '1.600.000', 'bulanan' => '5.000.000', 'file' => '/assets/images/l300_box-removebg-preview.png'],
                ['name' => 'L300', 'harian' => '300.000', 'mingguan' => '1.600.000', 'bulanan' => '5.000.000', 'file' => '/assets/images/l300-removebg-preview.png'],
                ['name' => 'GranMax', 'harian' => '450.000', 'mingguan' => '1.850.000', 'bulanan' => '5.300.000', 'file' => '/assets/images/granmax-removebg-preview.png'],
                ['name' => 'Viar', 'harian' => '250.000', 'mingguan' => '1.500.000', 'bulanan' => '4.000.000', 'file' => '/assets/images/viar-removebg-preview.png'],
                ['name' => 'Carry box', 'harian' => '400.000', 'mingguan' => '1.800.000', 'bulanan' => '5.300.000', 'file' => '/assets/images/pickup_putih-removebg-preview.png']
            ];
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 p-3 rounded-4 bg-white shadow-sm card-custom">
                    <div class="text-center py-3 bg-white border rounded-4 d-flex align-items-center justify-content-center" style="border-color: #ffbc80 !important; height: 180px;">
                        <img src="<?= base_url($c['file']) ?>" alt="<?= $c['name'] ?>" class="img-fluid px-2 object-fit-contain" style="max-height: 100%;">
                    </div>
                    ...
                    <div class="card-body px-0 pt-3 pb-0">
                        ...
                        <div class="price-info small mb-3 text-dark fw-bold">
                            ...
                            <div class="d-flex justify-content-between border-bottom py-1">
                                ...
                                <span class="text-orange">Rp.<?= $c['mingguan'] ?>,-</span>
                            </div>
        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-7">
                ...
                <div class="d-flex align-items-center gap-3">
                    <img src="/assets/images/l300-box" alt="100% Quality Guaranteed" style="height: 60px;">
            ...
            <div class="col-lg-5 text-center">
                <img src="<?= base_url('/assets/images/l300_box-removebg-preview.png') ?>" alt="About Pickup" class="img-fluid" style="max-height: 260px; object-fit: contain;">
            </div>
        </div>
    </div>
</section>
...
<section class="py-5" style="background-color: #e6e6e6;">
    <div class="container py-4 text-center">
        ...
        <div class="row g-4 mx-auto" style="max-width: 1000px;">
            <div class="col-md-4">
                <div class="card p-4 card-feature h-100">
